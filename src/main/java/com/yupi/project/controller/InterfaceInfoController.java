...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody IdRequest idRequest,
        ...
        com.yupi.elapiclientsdk.model.User user = new com.yupi.elapiclientsdk.model.User();
        // 设置user对象的username属性为"test"
        user.setUsername("test");
        // 通过elapiclientsdk的getUsernameByPost方法传入user对象，并将返回的username赋值给username变量
        String username = elApiClient.getUserNameByPost(user);
        // 如果username为空或空白字符串
...
// 返回结果把对象发出去就好了，因为不确定接口的返回值到底是什么
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        ElApiClient tempClient = new ElApiClient(accessKey, secretKey);
        Gson gson = new Gson();
        com.yupi.elapiclientsdk.model.User user = gson.fromJson(userRequestParams, com.yupi.elapiclientsdk.model.User.class);
